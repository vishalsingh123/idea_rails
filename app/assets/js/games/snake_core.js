...
snakeHeadImage.src = "/theme/idea/js/games/resources/head.png";
snakeBodyImage = new Image();
snakeBodyImage.src = "/theme/idea/js/games/resources/body.png";
snakeTailImage = new Image();
snakeTailImage.src = "/theme/idea/js/games/resources/tail.png";

//food
foodImage = new Image();
foodImage.src = "/theme/idea/js/games/resources/food.png";
...
function animate() 
{
	...
	if(game_over == false)
	{
		...
		displayText("Score: " + (snakeLen - 4), "score");
		display();
	}
	else
	{
		displayText(" Game Over....", "status");
	}
...
function displayText(what,type)
{
	id = (type == "score") ? "score_id" : "game_status_id";
	elem = document.getElementById(id);
 	elem.innerHTML = what;
//	context.font = "30px Arial";
///	context.fillText(what, dim1, dim2);
}
